  ...
  return (
    ...
    >
      ...
      <div className='flex flex-col gap-7'>
        ...
        <Link to="https://calendly.com/mrsteevtvw418/30min" target="_blank" className="bg-[#00ff26] hover:text-[#1D1D1B] text-[#1D1D1B] flex gap-1 px-6 py-4 cursor-pointer rounded-xl font-semibold w-[45%] md:w-full target">
          <p>Book a call</p>
          <img src={arrowIcon} alt="icon" width={20} className="" />
        </Link>
      </div>
