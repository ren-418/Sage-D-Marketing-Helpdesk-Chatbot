  ...
  return (
    <>
      <section className="relative flex flex-col items-start gap-8  h-screen bg-cover bg-center lg:px-32 px-5 md:px-10" style={{ backgroundImage: `url(${bg})` }}>
        ...
        <div>
          <Link to="https://calendly.com/mrsteevtvw418/new-meeting" className="bg-[#00ff26] text-[#1D1D1B]  flex gap-1 px-6 py-4 cursor-pointer rounded-xl font-semibold hover:text-black" target="_blank">
            <p>Book a call</p>
