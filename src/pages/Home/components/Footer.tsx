...
export default function Footer() {
    ...
    return (
        <footer>
            <div className="pt-[16.25px] pb-[40px] bg-white padding-control flex flex-row justify-between w-full max-[473px]:flex-col max-[473px]:gap-2 max-[473px]:items-center">
                <div className="flex flex-col max-[473px]:items-center">
                    ...
                    <div className="flex flex-row gap-[10px] justify-center items-center">
                        ...
                        <Link to="">
                            <svg xmlns="http://www.w3.org/2000/svg" data-name="Instagram w/circle" viewBox="0 0 19.2 19.2" width="32" height="32">
                ...
                <div className="flex flex-col text-poppins text-black items-end max-[473px]:items-center">
                    <Link to="" className="underline max-[473px]:text-center"> 888-296-0005 </Link>
                    <Link to="" className="underline"> save@millstreetenergy.com</Link>
                </div>
            </div>
        </footer>
    );
